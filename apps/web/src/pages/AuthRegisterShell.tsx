...
import { VI_NAME, VI_WELCOME } from '../config/brandConfig';
...
/**
 * Pantalla de registro (Auth0 signup) con mensaje de Vi y misma estética que login.
 */
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#050505] px-4 text-sm text-zinc-400">
      <div className="relative flex w-full max-w-md flex-col items-center gap-5">
        ...
        >
          <p className="mb-2 text-xs font-bold uppercase tracking-wider" style={{ color: VI_ACCENT }}>
            {VI_NAME}
          </p>
          <p className="text-sm leading-relaxed text-zinc-300">
            <span className="font-medium text-zinc-100">{VI_WELCOME}</span> Cada dato que registras me ayuda a darte
            mejores consejos. Empecemos a construir tu visión 360.
          </p>
        </motion.div>
